...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative bg-black">
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-blue-900/20 blur-[150px] rounded-full mix-blend-screen pointer-events-none"></div>
      ...
      <div className="w-full max-w-lg p-8 relative z-10">
        <div className="bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl p-12 shadow-2xl overflow-hidden relative group">
          ...
          <div className="flex flex-col items-center mb-10 border-b border-white/10 pb-8">
            <div className="w-10 h-10 border border-blue-500/50 flex items-center justify-center font-mono text-blue-400 mb-6 shadow-[0_0_15px_rgba(59,130,246,0.2)] rounded-sm">
              L
            </div>
            ...
            <p className="text-gray-400 text-sm font-sans font-light text-center">
              Sign in to access your predictive models
            </p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-6">
            ...
            >
              <span className="tracking-wide">{loading ? 'Authenticating...' : 'Sign In'}</span>
          ...
          <div className="mt-10 text-center border-t border-white/10 pt-6">
            <p className="font-mono text-[0.65rem] tracking-[0.15em] uppercase text-gray-500">
              Need an account?{' '}
              <Link to="/register" className="text-blue-400 hover:text-white transition-colors ml-1">
                Register
              </Link>
            </p>
          </div>
